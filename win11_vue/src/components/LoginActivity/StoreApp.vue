...
.ss :deep(.el-carousel__indicators--vertical) {
  display: -webkit-flex;
  display: flex;
...
:deep(.el-carousel__indicator:nth-child(1) button) {
  position: absolute;
  height: 18px;
  width: 18px;
  left: 11px;
...
:deep(.el-carousel__indicator:nth-child(2) button) {
  position: absolute;
  height: 18px;
  width: 18px;
  left: 11px;
...
:deep(.el-carousel__indicator:nth-child(3) button) {
  position: absolute;
  height: 18px;
  width: 18px;
  left: 11px;
...
:deep(.el-carousel__indicator:nth-child(4) button) {
  position: absolute;
  height: 18px;
  width: 18px;
  left: 11px;
...
:deep(.el-carousel__indicator:nth-child(5) button) {
  position: absolute;
  height: 18px;
  width: 18px;
  left: 11px;
